...
; insert the decompression code before the proper start (and check it fits)
* = $401
...
; ----------------------------------------------------------------------------------
; This code is executed by "CALLTOP" in the BASIC program above.
; It relocates everything below down to $500 in memory and jumps to 'main'
; in its new location.
reloc
    sec                         ;
...
load_initial
    ...
    ; We call the decompression code to continue loading and decompress
    ; the next section from tape.
    jsr decrunch                ;
